...
function runInventory42Tests() {
  ...
  const editable = buildEditableReviewCells_({
    ...
    cells: { warehouse:'B10', darkroom:'C10', finalTotal:'D10' }
  });
  assertCondition_(editable.Bar === 'B10' && editable.Zaplecze === 'C10' && !editable['Lodówki'],
    'Końcowy przegląd nie zwraca poprawnych pól Bar/Zaplecze.');
